...
public class ScreenPanel extends JPanel implements ActionListener {
    ...
    private void loadIcons() {
        ...
        ImageIcon iisnakepart = new ImageIcon(this.getClass().getResource("/snakepart.png"));
        snakepart = iisnakepart.getImage();

        ImageIcon iiapple = new ImageIcon(this.getClass().getResource("/apple.png"));
        apple = iiapple.getImage();

        ImageIcon iisnakehead = new ImageIcon(this.getClass().getResource("/snakehead.png"));
